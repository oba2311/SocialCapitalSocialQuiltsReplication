...
For privacy concerns, we have emptied columns containing explicit GPS locations, which were only used as part of the ERG estimations. 
...
#-Dist_Surv: distance matrix between each pair of surveyed individuals 
