...
while(measurecount<=14){
	...
	setwd("~/ProgramsAndCode/Results")
	name1=paste("ergm-distnorm-", name_basefile, "_", name_contextfile, sep="")
	...
	plotname=paste("~/ProgramsAndCode/Supp_Coefs",name2,".jpeg", sep="")
