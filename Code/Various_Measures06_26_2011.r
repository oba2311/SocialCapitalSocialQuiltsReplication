...
# this seems like a mistake to me and should have been 2011:
...
name2="Support_1_Vlevel06_26_2011"
name3="Support_2_Vlevel06_26_2011"
name4="Support_3_Vlevel06_26_2011"
name5="Support_4_Vlevel06_26_2011"
...
# modifications to the legend's size:
	...
	legend("topright", inset=c(-0.6,0),  c("Supported", "by 1", "by 2", "by 3", "by 4", "by 5"), col=c(1,4,2,3,1,1), lty=c(1,2,3,4,5,6), 
	       ncol = 1, cex = 0.6)
	print(paste("Writing...", plotname))	
	# savePlot(filename=plotname , type ="jpeg");
	# solve for a method that works, in a good resulution:
	png(file=plotname , width = 380, height = 380);
	dev.off()
